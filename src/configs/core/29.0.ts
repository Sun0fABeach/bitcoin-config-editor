	...
	[
		{
			...
			configs: {
				...
				txindex: {
					...
					shortDescription: 'Maintain full tx index, used by getrawtransaction rpc call',
					defaultValue: '0',
				},
			},
		},
		...
		},
		{
			...
			configs: {
				...
				asmap: {
					...
					title: 'ASN Mapping',
					description:
						'Specify asn mapping file used for bucketing of the peers. Relative paths will be prefixed by the net-specific <a href="#datadir">datadir</a> location. If set to 1, ip_asn.map will be used',
